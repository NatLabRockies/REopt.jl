...
elseif "CPLEX" in ARGS
    ...
    @testset verbose=true "REopt test set using HiGHS solver" begin
        ...
        @testset "CHP Sizing Heuristic" begin
            ...
            #Case 4: Heat + cool + electric but electric > heat + cool
            ...
            @test response["chp_elec_size_heuristic_kw"] ≈ 2000.0 atol=1e-3
            @test response["chp_max_size_kw"] ≈ 3000.0 atol=1e-3
        end
