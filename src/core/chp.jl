...
```julia
    ...
    supplementary_firing_installed_cost_per_mmbtu_per_hour::Float64 = 20000.0 # Installed CHP supplementary firing system cost in \$/MMBtu/hr of incremental thermal capacity
    supplementary_firing_max_ratio::Float64 = 1.0 # Ratio of max fired steam capacity relative to the steam generated by the CHP system when running at rated capacity. Relevant only for combustion_turbine prime_mover
...
Base.@kwdef mutable struct CHP <: AbstractCHP
    ...
    supplementary_firing_installed_cost_per_mmbtu_per_hour::Float64 = 20000.0
